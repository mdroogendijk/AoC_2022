namespace AdventOfCode.DaySeven
{
    public class PartTwo
    {
        ...
        public static int GetAnswer(string fileName)
        {
            ...
            // Calculate how much needs to be cleaned up
            int toBeDeleted = unusedSpaceRequired - (maxFileSystem - directoriesSizes.Max());

            // Answer is the smallest directory that suffices for the clean up
            return directoriesSizes.Where(size => size >= toBeDeleted).Min();
        }
    }
}